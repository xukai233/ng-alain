...
export class AppServiceProxy {
     ...
     * @return OK
     */
    createAuthorize(createTenantDto: AuthorizeTenantDto | null | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processcreateAuthorize(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processcreateAuthorize(<any>response_);
                } catch (e) {
    ...
    protected processcreateAuthorize(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TenantServiceProxy {
    ...
    searches(filterTenants: FilterTenantsDto | null | undefined): Observable<PagedResultDtoOfTenantListDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSearches(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSearches(<any>response_);
                } catch (e) {
    ...
    protected processSearches(response: HttpResponseBase): Observable<PagedResultDtoOfTenantListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    create(createTenantDto: CreateTenantDto | null | undefined): Observable<void> {
...
export class AccountServiceProxy {
    ...
    protected processSearches(response: HttpResponseBase): Observable<PagedResultDtoOfAccountsListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processupdatePut(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processget(response: HttpResponseBase): Observable<ListResultDtoOfPermissionDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class AccountGroupServiceProxy {
     ...
     * @return Success
     */
    create(createAccountGroup: CreateAccountGroupDto | null | undefined): Observable<void> {
...
export class AuditLogServiceProxy {
    ...
    protected processSearches(response: HttpResponseBase): Observable<PagedResultDtoOfAuditLogsListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
